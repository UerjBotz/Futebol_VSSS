...
class record:
    ...
    def __init__(self, x, y, root, call, path=path, dt=50):
        self.dt = dt
        w = 20
        self.icon_play = tk_icon(
            w,
            w,
            "C:/Users/UERJBotz/Documents/LF18/(00) GITHUB/Futebol_VSSS/images/icons/play-big.png",
        )
        self.icon_stop = tk_icon(
            w,
            w,
            "C:/Users/UERJBotz/Documents/LF18/(00) GITHUB/Futebol_VSSS/images/icons/stop-big.png",
        )
        ...
        self.voltage = wg.slider(
            0, 100, "voltage", self.frame2, length=50, default=50, border=2
        )
